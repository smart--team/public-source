...
import com.keyue.qlm.activity.Img_control;
...
public class TouchImageView extends ImageView { 
    ...
    public Bitmap gintama; 
    
    
    public void init(Img_control control){    	
	...
	public TouchImageView(Activity context,Bitmap bitmap) {
		super(context);
		gintama=bitmap;
